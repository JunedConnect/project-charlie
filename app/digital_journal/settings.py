...
from core.aws_secrets import get_aws_secret
import os
...
secret_data = get_aws_secret("django/production/secretkey")
...
CSRF_TRUSTED_ORIGINS = ['https://app.maajid.co.uk', 'http://app.maajid.co.uk']
